...
//        login.setRolList(roles);
    ...
    @Override
    public List<UsuarioFacade> getUsuariosList() {
        
        List<UsuarioFacade> usuarios = new ArrayList<UsuarioFacade>();
       ...
       + " group by u.usuario_id");
        ...
        for( Object[] object : list){
            ...
            UsuarioFacade uf = new UsuarioFacade( id, username, email, nombre, 
    ...
    @Override
    public void setRoles(UsuarioFacade usuarioFacade, List<Integer> rolesVista) {
