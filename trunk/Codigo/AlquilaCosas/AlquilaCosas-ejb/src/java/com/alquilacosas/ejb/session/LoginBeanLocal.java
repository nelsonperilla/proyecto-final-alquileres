...
public interface LoginBeanLocal {
    ...
    public UsuarioLogueado facebookLogin(java.lang.String email, String facebookId) throws com.alquilacosas.common.SeguridadException;

    public byte[] leerImagen(int id);

    boolean usarImagenLocal(Integer usuarioId);
