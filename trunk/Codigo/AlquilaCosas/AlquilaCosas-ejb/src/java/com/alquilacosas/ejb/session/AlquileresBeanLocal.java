...
public interface AlquileresBeanLocal {
    ...
    public void solicitarCambioAlquiler(int alquilerId, Date fechaFin, NombrePeriodo periodo, Integer duracion) throws com.alquilacosas.common.AlquilaCosasException;
